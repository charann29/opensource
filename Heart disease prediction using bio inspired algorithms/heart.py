...
heart_disease_data = pd.read_csv(r'C:\Users\Revoori Murarji\OneDrive\Documents\Heart disease prediction using bio inspired algorithms\heart_disease_model.csv')
